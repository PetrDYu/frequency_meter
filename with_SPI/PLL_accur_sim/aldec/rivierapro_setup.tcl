...
# ACDS 16.0 211 win32 2020.08.29.00:56:19
# ----------------------------------------
...
# ----------------------------------------
# If PLL_accur is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_accur.vo"
}
